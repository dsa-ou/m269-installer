...
1. Delete folder `~/venvs/m269-26j`.

2. **Windows**: delete any desktop shortcuts you created.

3. Find out which file defines commands `m269-26j` and `nb`:
...
5. Search for the lines that define `m269-26j` and `nb`. Delete those lines.
...
2. Delete all lines from `/* Start of M269-26J ... */` to `/* End of M269-26J ... */`.
